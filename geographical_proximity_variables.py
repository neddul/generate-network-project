...
def Sun2000Inr_creator(amount): 
    ...
    random_letters = random.choices(alphabet, k=amount)
...
def create_utbildning(amount):
    ...
    SUN2000Grp = random.choices(grupper, k=amount)
